# =============================================================================
# claude-pipeline: stack deno の setup (Deno CLI)
#
# opts: deno_version (例 "2.1.4"。空なら最新)
# 公式 installer (deno.land/install.sh → dl.deno.land) で PIPELINE_ROOT/deno に入れて PIPELINE_BIN に
...
pl_setup_deno() {
  ...
  local DENO_HOME="$PIPELINE_ROOT/deno" V="" target url
