# =============================================================================
# sweepline: stack node の setup (任意の Node / npm の pin)
#
# opts: node_version (例 "20" / "20.18" / "20.18.1"。空なら VM 既定の node 22 を使う)
#       npm_version  (空なら触らない)
# node は nodejs.org の公式 tarball を SWEEPLINE_ROOT/node に展開し SWEEPLINE_BIN に symlink する
...
pl_setup_node() {
  ...
  local NODE_HOME="$SWEEPLINE_ROOT/node" NPM="npm" arch cur full="" tmp exe
